...
instance Print AbsCpp.Exp where
  prt i e = case e of
    ...
    AbsCpp.EIds id1 id2 -> prPrec i 16 (concatD [prt 0 id1, doc (showString "::"), prt 0 id2])
    AbsCpp.EArray mem exp -> prPrec i 15 (concatD [prt 0 mem, doc (showString "["), prt 2 exp, doc (showString "]")])
    AbsCpp.EFunc mem exps -> prPrec i 15 (concatD [prt 0 mem, doc (showString "("), prt 2 exps, doc (showString ")")])
