...
instance Print AbsCPP.Def where
  prt i e = case e of
    ...
    AbsCPP.DTInline type_ id args -> prPrec i 0 (concatD [doc (showString "inline"), prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), doc (showString ";")])
    AbsCPP.DTemp type_ id args -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), doc (showString ";")])
...
instance Print AbsCPP.Exp where
  prt i e = case e of
    ...
    AbsCPP.QConst qconst -> prPrec i 16 (concatD [prt 0 qconst])
    AbsCPP.EArray exp1 exp2 -> prPrec i 15 (concatD [prt 16 exp1, doc (showString "["), prt 11 exp2, doc (showString "]")])
    AbsCPP.EFunc exp exps -> prPrec i 15 (concatD [prt 16 exp, doc (showString "("), prt 0 exps, doc (showString ")")])
